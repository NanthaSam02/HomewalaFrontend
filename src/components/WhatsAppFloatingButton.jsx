...
export default function WhatsAppFloatingButton({
  phone = "918925997080",
  message = "Hi! I found you on the website, I need help.",
...
>
      ...
      {showLabel && (
        <a
          ...
          className="hidden sm:inline-block bg-white/90 backdrop-blur-md px-3 py-2 rounded-full shadow-md text-sm font-medium hover:bg-white hover:shadow-lg transition"
        >
          Chat on WhatsApp
        </a>
      )}

      {/* ✅ Perfectly solid WhatsApp icon */}
     <a
  href={href}
  target="_blank"
  rel="noopener noreferrer"
  ...
  style={{
    width: `${size}px`,
    height: `${size}px`,
    borderRadius: "25%", // ✅ perfect app icon curve
    backgroundColor: "#25D366", // ✅ official WhatsApp green
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    overflow: "visible", // 👈 ensures full logo visible
  }}
>
