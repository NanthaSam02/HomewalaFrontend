 ...
 useEffect(() => {
  ...
  const handlelocation = useCallback((data) => {
    ...
    if (String(data).trim().toLowerCase() === 'chennai') {
      ...
      navigate('/properties-for-sale-in-chennai/' + String(data).toLowerCase());
    }
  }, [dispatch, navigate]);
              ...
              <div className="absolute left-0 mt-2 bg-white border rounded shadow-lg w-[280px] sm:w-[350px] md:w-[450px] lg:w-[700px] z-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-4 sm:p-6">
                  ...
                  <div className="sm:col-span-2 lg:col-span-1">
                    ...
                    <ul className="space-y-2">
                      {[
 { label: "₹ 15 lakhs to 35 lakhs", min: 1500000, max: 3500000 },
 { label: "₹ 35 lakhs to 50 lakhs", min: 3500000, max: 5000000 },
 { label: "₹ 50 lakhs to 75 lakhs", min: 5000000, max: 7500000 },
 { label: "₹ 75 lakhs above", min: 7500000, max: 999999999 }
].map((item) => (
                        <li key={item.label}>
                          <button
                            className="text-gray-700 hover:text-blue-500 transition-colors text-xs sm:text-sm"
...
// const handleBudgetSelection = useCallback((min) => {

//   const updatedFilter = {
//     paginate: 1,
//     min_price: min,
//     max_price: 999999999, // big value so it takes all above
...
//  { label: "₹ 35 Lakhs+", min: 3500000 },
//  { label: "₹ 50 Lakhs+", min: 5000000 },
//  { label: "₹ 75 Lakhs+", min: 7500000 },
// ].map((item) => (
//                         <li key={item.label}>
//                           <button
//                             className="text-gray-700 hover:text-blue-500 transition-colors text-xs sm:text-sm"
//                             onClick={() => handleBudgetSelection(item.min)}
//                           >
//                             {item.label}
//                           </button>
//                         </li>
...
//                             className="text-gray-700 hover:text-blue-500 text-sm w-full text-left py-1 px-2 rounded hover:bg-gray-100"
//                             onClick={() => {
//                               handleBudgetSelection(item.min);
//                               setIsMobileBuyDropdownOpen(false);
//                               setIsMobileMenuOpen(false);
//                             }}
//                           >
